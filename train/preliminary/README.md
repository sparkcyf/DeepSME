...
- the `train/preliminary/kmer_extraction/kmer_models/dna_r9.4.1_400bps_6mer_5hmc.csv` can be used for [Uncalled4](https://github.com/skovaka/uncalled4/) and [squigulator](https://github.com/hasindu2008/squigulator).
